...
<div class="container pb-5">
    ...
    <div class="row">
        <div class="col-md-8 mainContent">
            ...
            <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="refund_policy" name="refund_policy" value="1"
                    required="" <?php if ($this->session->userdata('refund_policy') == 1) {
                        echo "checked";
                    } ?>>
                <label class="custom-control-label" for="refund_policy"><?php echo display('refund_policy') ?><span
                        class="text-danger">*</span> <a href="<?php echo base_url('refund_policy') ?>"
                        target="_blank"><i class="fa fa-external-link"></i></a></label>
            </div>
