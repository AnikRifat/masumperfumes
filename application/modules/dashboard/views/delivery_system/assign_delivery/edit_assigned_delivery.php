            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo form_open('dashboard/Cdelivery_system/edit_assigned_delivery/' . $assigned_refund_info['delivery_id']); ?>
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" required name="delivery_boy_id" id="delivery_boy_id">
                                    ...
                                    <option value="<?php echo html_escape($delivery_boy->id) ?>"
                                        <?php echo ($delivery_boy->id == $assigned_refund_info['delivery_boy_id']) ? 'selected' : '' ?>>
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" required name="delivery_zone_id" id="delivery_zone_id">
                                    ...
                                    <option value="<?php echo $delivery_zone->id ?>"
                                        <?php echo ($delivery_zone->id == $assigned_refund_info['delivery_zone_id']) ? 'selected' : '' ?>>
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" required name="time_slot_id" id="time_slot_id">
                                    ...
                                    <option value="<?php echo $time_slot->id ?>"
                                        <?php echo ($time_slot->id == $assigned_refund_info['time_slot_id']) ? 'selected' : '' ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="datetime-local"
                                    value="<?php echo html_escape($assigned_refund_info['completed_at']) ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control summernote" rows="3" name="note"
                                    id="note"><?php echo html_escape($assigned_refund_info['note']) ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <label class="radio-inline">
                                <input type="radio" class="col-sm-2 col-form-label" name="status" value="1"
                                    <?php echo (($assigned_refund_info['status'] == '1') ? 'checked' : '') ?>><strong><?php echo display('active'); ?></strong>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" class="col-sm-2 col-form-label" name="status" value="0"
                                    <?php echo (($assigned_refund_info['status'] == '0') ? 'checked' : '') ?>>
